                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <?php 
                                        ...
                                        $preference->back_urls = array(
                                            "success" => "https://manuelmannuel-mp-ecommerce-php.herokuapp.com/respuesta.php?id=success",
                                            "failure" => "https://manuelmannuel-mp-ecommerce-php.herokuapp.com/respuesta.php?id=failure",
                                            "pending" => "https://manuelmannuel-mp-ecommerce-php.herokuapp.com/respuesta.php?id=pending"
                                        );
